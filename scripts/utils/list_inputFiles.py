...
all_representative_experiments=[
...
('20190318', 'SS29621-tdTomGC6fopt', 'fly1', '001'), # no video
('20190318', 'SS29621-tdTomGC6fopt', 'fly1', '002'), # no video
...
('20190318', 'SS29621-tdTomGC6fopt', 'fly1', '007'), # no video
('20190318', 'SS29621-tdTomGC6fopt', 'fly1', '008'), # no video
('20190318', 'SS29621-tdTomGC6fopt', 'fly1', '009'), # no video


('20190328', 'SS29893-tdTomGC6fopt', 'fly3', '001'),
('20190328', 'SS29893-tdTomGC6fopt', 'fly3', '002'),
('20190328', 'SS29893-tdTomGC6fopt', 'fly3', '003'),
('20190328', 'SS29893-tdTomGC6fopt', 'fly3', '004'), # no video
('20190328', 'SS29893-tdTomGC6fopt', 'fly3', '005'), # no video
('20190328', 'SS29893-tdTomGC6fopt', 'fly3', '006'),
('20190328', 'SS29893-tdTomGC6fopt', 'fly3', '007'),
('20190328', 'SS29893-tdTomGC6fopt', 'fly3', '008'), # no video
('20190328', 'SS29893-tdTomGC6fopt', 'fly3', '009'), # no video


('20190415', 'SS29633-tdTomGC6fopt', 'fly1', '001'), # no video
...
('20190415', 'SS29633-tdTomGC6fopt', 'fly1', '007'), # no video
('20190415', 'SS29633-tdTomGC6fopt', 'fly1', '008'), # no video
('20190415', 'SS29633-tdTomGC6fopt', 'fly1', '009'), # no video
('20190415', 'SS29633-tdTomGC6fopt', 'fly1', '010'), # no video
...
('20190405', 'SS30303-tdTomGC6fopt', 'fly2', '006'), # no video
...
('20190410', 'SS31456-tdTomGC6fopt', 'fly1', '001'), # no video
...
('20190417', 'SS31480-tdTomGC6fopt', 'fly1', '003'), # no video
('20190417', 'SS31480-tdTomGC6fopt', 'fly1', '004'),
('20190417', 'SS31480-tdTomGC6fopt', 'fly1', '005'),
('20190417', 'SS31480-tdTomGC6fopt', 'fly1', '007'), # no video
...
('20190516', 'SS36118-tdTomGC6fopt', 'fly4', '001'), # no video
('20190516', 'SS36118-tdTomGC6fopt', 'fly4', '002'), # no video
...
('20190516', 'SS36118-tdTomGC6fopt', 'fly4', '007'), # no video
...
('20190521', 'SS36131-tdTomGC6fopt', 'fly1', '007'), # no video
('20190521', 'SS36131-tdTomGC6fopt', 'fly1', '008'), # no video

('20190531', 'SS38592-tdTomGC6fopt', 'fly3', '002'), # no video
...
('20190918', 'SS52147-tdTomGC6fopt', 'fly1', '007'), # no video
...
# ('20180822', 'SS25451-tdTomGC6fopt', 'fly4', '002'), # noisy
...
('20180822', 'SS25451-tdTomGC6fopt', 'fly4', '015'), # no video
...
population_lines_recordings=[
#(data,       Gal4,                  fly,    rcrd, ROIs, time_s)
...
off_ball_inactivate_lines_ONBALL=[

('20190522', 'SS34574-tdTomGC6fopt', 'fly2', '001'), # on ball
('20190610', 'SS40489-tdTomGC6fopt', 'fly3', '004'), # on ball #axoid not done ...
('20190615', 'SS40134-tdTomGC6fopt', 'fly1', '005'), # on ball 
('20190619', 'SS41605-tdTomGC6fopt', 'fly3', '003'), # on ball
('20190704', 'SS42749-tdTomGC6fopt', 'fly1', '002'), # on ball # Abd bending push
('20190712', 'SS43652-tdTomGC6fopt', 'fly2', '001'), # on ball # resting
...
off_ball_inactivate_lines_OFFBALL=[

('20190522', 'SS34574-tdTomGC6fopt', 'fly2', '006'), # hanged fly #check move/rest threshold
# ('20190610', 'SS40489-tdTomGC6fopt', 'fly3', '006'), # hanged fly #axoid not done ...
# ('20190615', 'SS40134-tdTomGC6fopt', 'fly1', '008'), # hanged fly #axoid not done ...
('20190619', 'SS41605-tdTomGC6fopt', 'fly3', '007'), # hanged fly
('20190704', 'SS42749-tdTomGC6fopt', 'fly1', '004'), # hanged fly
('20190712', 'SS43652-tdTomGC6fopt', 'fly2', '003'), # hanged fly
...
# ('20190410', 'SS31456-tdTomGC6fopt', 'fly1', '006'), # on ball jump-and-extend

('20190411', 'SS31456-tdTomGC6fopt', 'fly2', '004'), # on ball
('20190411', 'SS31456-tdTomGC6fopt', 'fly2', '005'), # on ball
('20190411', 'SS31456-tdTomGC6fopt', 'fly2', '006'), # on ball

('20190531', 'SS38592-tdTomGC6fopt', 'fly3', '005'), # on ball
...
('20190924', 'SS51021-tdTomGC6fopt', 'fly1', '001'), # on ball
('20190924', 'SS51021-tdTomGC6fopt', 'fly1', '002'), # on ball
...
('20190411', 'SS31456-tdTomGC6fopt', 'fly2', '001'), 
('20190411', 'SS31456-tdTomGC6fopt', 'fly2', '008'), 

('20190531', 'SS38592-tdTomGC6fopt', 'fly3', '006'), # hanged fly #good
...
('20190924', 'SS51021-tdTomGC6fopt', 'fly1', '003'), # hanged fly #check dur threshold for move/rest, dur can be longer
